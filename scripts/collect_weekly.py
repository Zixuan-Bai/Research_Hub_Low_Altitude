"""Collect low-altitude research-intelligence items and update the review dashboard."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Collect research-intelligence items.")
    ...
    print(f"New or updated items: {len(changed_items)}")
